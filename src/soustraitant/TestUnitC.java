...
public class TestUnitC extends TestCase{

	ConstructionBTP a = new ConstructionBTP("A");
	ConstructionBTP b = new ConstructionBTP("B");

	ConstructionBTP c = new ConstructionBTP("C");
	ConstructionBTP d = new ConstructionBTP("D");
